...
'532':'Restore',
'443':'Firmware Update',
'431':'Firmware is the software which keeps your A1 Mesh WLAN  network running and controls its features and functions. From time to time, A1 may provide new firmware to improve functionality and performance. To check for updates, please click the check button below.',
'432':'Note: An update takes about 200 seconds to complete, after which your A1 Mesh WLAN network will reboot. Please do not turn off or unplug any of the devices before the update is complete.',
'437':'Firmware:',
...
'441':'At the end of the upgrade, the Router may not respond to commands for as long as 200 seconds. This is normal. Do not turn off or reboot the Router during this time.',
...
'427':'Restoring the default settings will take up to 200 seconds. Do not turn off power to the Router during this process.',
...
'601':'Check',
'602':'Manual Update',
'603':'Alternatively, you can check the A1 website for updated firmware. You\'ll need to download the file and select it below to complete the upgrade.',
'604':'Current Version:',
'605':'Latest Version:',
'606':'An updated version of firmware is available. Please click the upgrade button to begin the process.',
'607':'You already have the latest version of firmware.',
'608':'The image file is invalid!',
'609':'Your A1 Mesh WLAN system is not connected to the Internet. Please check your Ethernet cable connection and router before attempting to check for updates.',
'':null});
