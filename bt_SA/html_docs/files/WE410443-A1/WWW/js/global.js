...
function ShowPageTail_fw(_hid){
 ...
 //<!-- Loader we will loading load submit action purpose-->
   ...
   $W('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
   $W('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
     $W('<span class="arcFont4" id="MSG" style="display:none"></span><br><br><br><br>');
	 $W('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	...
	$W('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	$W('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
     $W('<span class="arcFont2" id="timeRemain" style="display:none"></span></span><br><br><br><br>');
	 $W('<span class="atcFont2" id="remindmsg" style="display:none"></span><br><br><br>');
...
/*DEMO*/
	//if(!_nodbg)
	//  return '<font style="border:dashed #ff0000 2px" title="id='+_id+'">'+s+'</font>';
//	else
/*END_DEMO*/
	  return getLangC(s);
...
function SetTitle(_til){
	var bt_til = "A1 Mesh WLAN - " + _til;//add title for a1 by leo 
...
function getApplyErrMsg(err){
	...
	"-1":"com_fw_fail", // System no respond or unknow error
	 ...
	 "99":"com_dut_alive"  // detect DUT if alive
	};
	/* cgi feedback*/
	var msg="";
	if(ErrMsg[err]){
	...
	top.G_ptimer = setInterval(function(){
			...
			function(){
					if(top.G_option.isfwdl == 1)
					{
						...
						if(lang_used==0)//if use language english 0 german 4
						{
							if(minute_remain)
								setIdVal("timeRemain",minute_remain+" minute "+second_remain+" seconds remaining");
							else
							...
							if(minute_remain)
								setIdVal("timeRemain",minute_remain+" Minute "+second_remain+" Sekunden verbleibende");
							else
								setIdVal("timeRemain",second_remain+" Sekunden verbleibende");
...
//	     }
      ...
      if(ElemObj) {
		...
		/*DMEO*/
        //if(dbg){
		//    ElemObj.style.border="dashed #ff0000 2px";
...
//	id=(id)? id:0;
	id=(lang_used=="")?4:parseInt(lang_used,10);	//Default used the Deutsch;
	id=chkLang(id);
