...
SlideBar.prototype = {
	...
	addScale : function(slideBar, interval, total, barLength){
		...
		var num = total / interval; //num	how many scales should be
		...
		for (var i = 0; i < num + 1; i++) {
			...
			oScale.style.background = '#429500';  //Indicator color
			...
			if(langselect == 4)
			{
				if(i == 0)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Aus</span>";
				}
				if(i == 1)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Dunkel</span>";
				}
				if(i == 2)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Normal</span>";
				}
			...
			else
			{
				if(i == 0)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Off</span>";
				}
				if(i == 1)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Dim</span>";
				}
				if(i == 2)
				{
					oText.innerHTML = "<br/><span style='color:#666666; font-size: 10pt; font-family:Calibri;'>Normal</span>";
	...
	/*	Check target (confirm movement direction) and slide	*/
