...
//"
	...
	***************************/
	...
	$.fn.arcTransCreateInputButton=function(option){
		...
		if(Math.ceil(inputSize*1.5)>80)
			midcss='style="height:40px;width:'+Math.ceil(inputSize*1.5)+'px;"'; //IE7:10, IE8: 15px, IE9/Chrmoe: 10
		else
			midcss='style="height:40px;width:'+80+'px;"';
...
*/
	...
	*/
	    ...
	    htm+='onFocus="$(this).arcTransInputHover(0)" '+
	    	 ...
	    	 'onkeyup="$(this).arcTransInputHover(1)" '+
